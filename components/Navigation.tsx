...
import myLogoPNG from "@/public/logo/myLogoPNG.png";
...
export default function Navigation() {
  ...
  return (
    <header
      className={clsx(
        "sticky top-0 z-20 bg-white transition-all duration-300 dark:bg-black lg:border-b",
    ...
    >
      <nav className="lg mx-auto flex max-w-[700px] items-center justify-between gap-3 px-4 py-3 md:px-6">
        <Link href="/" className="shrink-0 text-primary">
          <Image src={myLogoPNG} width={36} height={36} alt="logo" />
        </Link>
